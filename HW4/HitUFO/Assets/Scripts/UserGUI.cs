...
public class UserGUI : MonoBehaviour {
	...
	void OnGUI () {
		...
		GUI.Label(new Rect(Screen.width - 300, Screen.height / 2-150, 100, 50), "Score: " + action.getScore().ToString(),scoreStyle);
        GUI.Label(new Rect(Screen.width - 150, Screen.height / 2-150, 100, 50), "Round: " + action.getRound().ToString(),scoreStyle);
		if(blood == 0){
